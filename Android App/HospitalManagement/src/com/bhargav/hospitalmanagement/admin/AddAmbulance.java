...
public class AddAmbulance extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.admin_addambulance);
	...
	public void onClick(View v) {
		...
		{
		case R.id.BtnOK:
			QueryExecutor QE = new QueryExecutor(AddAmbulance.this);
